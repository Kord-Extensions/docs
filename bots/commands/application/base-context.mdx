...
see [the basic command context API page](/bots/commands/base-context).

All application command contexts also extend one of the [interaction context types (TODO)](#), unless you're writing
[an unsafe command (TODO)](#).
