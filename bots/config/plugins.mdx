...
sidebar_custom_props:
  ...
  icon: "fluent:puzzle-piece-24-filled"
---
...
<Doc.Container>
  ...
  <Doc.Property name="disabledPlugins" type="MutableList<String>" default="mutableListOf()" propType="var">
  ...
  <Doc.Property name="pluginPaths" type="MutableList<Path>" default={`mutableListOf(Path("./plugins"))`} propType="var">
