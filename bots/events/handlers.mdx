...
This type provides a set of APIs, along with those provided by [the base `TranslatableContext` type](#),
...
<Doc.Container>
  <Doc.Type name="EventContext" type="class" extends={["KordExKoinComponent", "TranslatableContext"]} open>
    ...
    <Doc.Property name="sentry" type="SentryContext" propType="val">
      A [Sentry context](#) you can use to keep track of what happens in your event handler.
    </Doc.Property>
  </Doc.Type>
</Doc.Container>
