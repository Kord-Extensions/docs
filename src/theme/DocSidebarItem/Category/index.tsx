...
function useAutoExpandActiveCategory(
	...
	{ isActive: boolean; collapsed: boolean; updateCollapsed: (b: boolean) => void; }
) {
...
function CollapseButton(
	{collapsed, categoryLabel, onClick,}:
	{ collapsed: boolean; categoryLabel: string; onClick: ComponentProps<"button">["onClick"]; }
) {
	return (
		<button
			aria-label={
		...
		<li
			...
			<div
				...
				<Link
					...
					{...props}>
					<span style={{height: "1.3em", whiteSpace: "nowrap", maxWidth: "90%", overflowY: "visible", overflowX: "visible"}}>{label}</span>
					{processTags({item})}
				</Link>
				{href && collapsible && (
					<CollapseButton
